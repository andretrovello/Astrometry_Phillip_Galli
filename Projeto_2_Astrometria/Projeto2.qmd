...
# --- CORREÇÃO NO TÍTULO ---
ax.set_title(f'DBSCAN Região de Taurus ({n_clusters-1} clusters)', fontsize=14) # Removido o '-1'
ax.set_xlabel('l(°)', fontsize=12)
ax.set_ylabel('b(°)', fontsize=12)
...
fig.suptitle(f'Histogramas de Paralaxe - DBSCAN (Total: {n_clusters-1} clusters)', fontsize=20, y=1.06)
plt.show()
```
...
fig.suptitle(f'Histogramas de Paralaxe - HDBSCAN (Total: {n_clusters-1} clusters)', fontsize=20, y=1.06)
plt.show()
```