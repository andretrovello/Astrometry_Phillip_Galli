...
\tipo{Astrometria - Projeto 1}
\titulo{Determinando a Distância do Aglomerado Aberto NGC 1662 com Inferência Bayesiana}
\aluno{André Almeida Trovello}
\emailaluno{andretrovello@usp.br}
\emailorientador{pcoelho@usp.br}
\palavraschave{Aglomerados Abertos, Inferência Bayesiana, Medida de Distância, Gaia DR3}
\data{\today}
...
\geometry{margin=1in}
\usepackage{etoolbox}
\usepackage{fixltx2e} % Pacote para compatibilidade com comandos antigos
